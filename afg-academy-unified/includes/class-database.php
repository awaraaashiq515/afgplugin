...
class AFG_Database {
    ...
    public static function create_tables() {
        ...
        // Update version
        update_option('afg_unified_db_version', AFG_UNIFIED_VERSION);
    }
    ...
    private static function create_subscriptions_table($charset_collate) {
        global $wpdb;
        $table = $wpdb->prefix . 'afg_subscriptions';
    ...
    private static function create_invoices_table($charset_collate) {
        global $wpdb;
        $table = $wpdb->prefix . 'afg_invoices';
    ...
    private static function create_whatsapp_logs_table($charset_collate) {
        global $wpdb;
        $table = $wpdb->prefix . 'afg_whatsapp_logs';
    ...
    public static function tables_exist() {
        ...
        $required_tables = array(
            ...
            $wpdb->prefix . 'afg_subscriptions',
            $wpdb->prefix . 'afg_invoices',
            $wpdb->prefix . 'afg_queries',
            $wpdb->prefix . 'afg_whatsapp_logs'
        );
    ...
    public static function get_db_version() {
        return get_option('afg_unified_db_version', '0.0.0');
    }
    ...
    public static function drop_tables() {
        ...
        delete_option('afg_unified_db_version');
    }
