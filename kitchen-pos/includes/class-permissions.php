...
class KPOS_Permissions {
    ...
    public static function can_create_orders() {
        return current_user_can('create_dkm_orders') || current_user_can('manage_dkm_pos');
    }
    ...
    public static function can_view_products() {
        return current_user_can('view_dkm_products') || current_user_can('manage_dkm_pos');
    }
    ...
    public static function can_search_trainees() {
        return current_user_can('search_dkm_trainees') || current_user_can('manage_dkm_pos');
    }
