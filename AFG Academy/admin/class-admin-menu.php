...
class DKM_Admin_Menu {
    ...
    public static function register_menus() {
        ...
        add_menu_page(
            __('AFG Academy', 'deshi-kitchen-admin'),
            __('AFG Academy', 'deshi-kitchen-admin'),
        ...
        add_submenu_page(
            'deshi-kitchen',
            __('Dashboard', 'deshi-kitchen-admin'),
            __('Dashboard', 'deshi-kitchen-admin'),
            'read',
            'deshi-kitchen',
            array(__CLASS__, 'render_dashboard')
    ...
    // Products
        add_submenu_page(
            'deshi-kitchen',
            __('Kitchen Products', 'deshi-kitchen-admin'),
            __('Products', 'deshi-kitchen-admin'),
            'view_dkm_products',
            'deshi-products',
        ...
        add_submenu_page(
            'deshi-kitchen',
            __('Trainees Management', 'deshi-kitchen-admin'),
            __('Trainees', 'deshi-kitchen-admin'),
            'manage_dkm_trainees',
            'deshi-trainees',
        ...
        add_submenu_page(
            'deshi-kitchen',
            __('Subscriptions', 'deshi-kitchen-admin'),
            __('Subscriptions', 'deshi-kitchen-admin'),
        ...
        add_submenu_page(
            'deshi-kitchen',
            __('Monthly Invoices', 'deshi-kitchen-admin'),
            __('Invoices', 'deshi-kitchen-admin'),
            'manage_dkm_invoices',
            'deshi-invoices',
        ...
        add_submenu_page(
            'deshi-kitchen',
            __('Support Queries', 'deshi-kitchen-admin'),
            __('Support', 'deshi-kitchen-admin'),
            'manage_dkm_queries',
            'deshi-queries',
        ...
        add_submenu_page(
            'deshi-kitchen',
            __('Reports & Analytics', 'deshi-kitchen-admin'),
            __('Reports', 'deshi-kitchen-admin'),
            'view_dkm_reports',
            'deshi-reports',
        ...
        add_submenu_page(
            'deshi-kitchen',
            __('Settings', 'deshi-kitchen-admin'),
            __('Settings', 'deshi-kitchen-admin'),
            'manage_dkm_settings',
            'deshi-settings',
    ...
    public static function render_dashboard() {
        ...
        if (file_exists($view_file)) {
            ...
            echo '<div class="wrap">';
            echo '<h1>' . __('Dashboard', 'deshi-kitchen-admin') . '</h1>';
            echo '<div class="notice notice-warning"><p>' . __('Dashboard view file not found.', 'deshi-kitchen-admin') . '</p></div>';
            echo '</div>';
        }
    }
    ...
    public static function render_products() {
        ...
        if (file_exists($view_file)) {
            ...
            echo '<div class="wrap">';
            echo '<h1>' . __('Kitchen Products', 'deshi-kitchen-admin') . '</h1>';
            echo '<div class="notice notice-info">';
            echo '<p>' . __('Products are managed through WooCommerce. Go to:', 'deshi-kitchen-admin') . '</p>';
            echo '<p><a href="' . admin_url('edit.php?post_type=product') . '" class="button button-primary">';
            echo __('WooCommerce Products', 'deshi-kitchen-admin') . '</a></p>';
            echo '</div>';
            echo '</div>';
        }
    }
    ...
    public static function render_settings() {
        ...
        if (isset($_POST['dkm_save_settings']) && check_admin_referer('dkm_settings_nonce')) {
            self::save_settings();
            echo '<div class="notice notice-success is-dismissible"><p>' . __('Settings saved successfully!', 'deshi-kitchen-admin') . '</p></div>';
        }
    ...
    private static function render_settings_page() {
        ?>
        <div class="wrap">
            <h1><?php _e('Deshi Kitchen Settings', 'deshi-kitchen-admin'); ?></h1>
            ...
            <form method="post" action="">
                ...
                <table class="form-table">
                    ...
                    <tr>
                        <th scope="row">
                            <label for="dkm_currency_symbol"><?php _e('Currency Symbol', 'deshi-kitchen-admin'); ?></label>
                        </th>
                        <td>
                            <input type="text" 
                                   ...
                                   class="regular-text">
                            <p class="description"><?php _e('Currency symbol to display (e.g., ₹, $, €)', 'deshi-kitchen-admin'); ?></p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th scope="row">
                            <label for="dkm_credit_limit"><?php _e('Credit Limit', 'deshi-kitchen-admin'); ?></label>
                        </th>
                        <td>
                            <input type="number" 
                                   id="dkm_credit_limit" 
                                   ...
                                   class="regular-text"
                                   step="100">
                            <p class="description"><?php _e('Maximum credit balance allowed per trainee', 'deshi-kitchen-admin'); ?></p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th scope="row">
                            <label for="dkm_low_stock_threshold"><?php _e('Low Stock Alert', 'deshi-kitchen-admin'); ?></label>
                        </th>
                        <td>
                            <input type="number" 
                                   ...
                                   class="regular-text">
                            <p class="description"><?php _e('Alert when stock falls below this number', 'deshi-kitchen-admin'); ?></p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th scope="row">
                            <label for="dkm_whatsapp_enabled"><?php _e('WhatsApp Notifications', 'deshi-kitchen-admin'); ?></label>
                        </th>
                        <td>
                            <select id="dkm_whatsapp_enabled" name="dkm_whatsapp_enabled">
                                <option value="no" <?php selected(get_option('dkm_whatsapp_enabled', 'no'), 'no'); ?>><?php _e('Disabled', 'deshi-kitchen-admin'); ?></option>
                                <option value="yes" <?php selected(get_option('dkm_whatsapp_enabled', 'no'), 'yes'); ?>><?php _e('Enabled', 'deshi-kitchen-admin'); ?></option>
                            </select>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th scope="row">
                            <label for="dkm_invoice_prefix"><?php _e('Invoice Prefix', 'deshi-kitchen-admin'); ?></label>
                        </th>
                        <td>
                            <input type="text" 
                                   ...
                                   class="regular-text">
                            <p class="description"><?php _e('Prefix for invoice numbers (e.g., INV-2024-001)', 'deshi-kitchen-admin'); ?></p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th scope="row">
                            <label for="dkm_invoice_due_days"><?php _e('Invoice Due Days', 'deshi-kitchen-admin'); ?></label>
                        </th>
                        <td>
                            <input type="number" 
                                   ...
                                   class="regular-text">
                            <p class="description"><?php _e('Number of days from invoice generation to due date', 'deshi-kitchen-admin'); ?></p>
                        </td>
                    </tr>
                </table>
                ...
                <p class="submit">
                    <button type="submit" name="dkm_save_settings" class="button button-primary">
                        <?php _e('Save Settings', 'deshi-kitchen-admin'); ?>
                    </button>
                </p>
            </form>
            ...
            <!-- System Info -->
            <hr>
            <h2><?php _e('System Information', 'deshi-kitchen-admin'); ?></h2>
            <table class="widefat">
                <tbody>
                    <tr>
                        <td><strong><?php _e('Plugin Version', 'deshi-kitchen-admin'); ?></strong></td>
                        <td><?php echo DKM_ADMIN_VERSION; ?></td>
                    </tr>
                    <tr>
                        <td><strong><?php _e('Database Version', 'deshi-kitchen-admin'); ?></strong></td>
                        <td><?php echo DKM_Database::get_db_version(); ?></td>
                    </tr>
                    <tr>
                        <td><strong><?php _e('WooCommerce Active', 'deshi-kitchen-admin'); ?></strong></td>
                        <td><?php echo class_exists('WooCommerce') ? '✅ Yes' : '❌ No'; ?></td>
                    </tr>
                    <tr>
                        <td><strong><?php _e('Tables Exist', 'deshi-kitchen-admin'); ?></strong></td>
                        <td><?php echo DKM_Database::tables_exist() ? '✅ Yes' : '❌ No'; ?></td>
                    </tr>
                    <tr>
                        <td><strong><?php _e('Total Trainees', 'deshi-kitchen-admin'); ?></strong></td>
                        <td><?php echo count(DKM_Roles_Capabilities::get_trainees()); ?></td>
                    </tr>
                    <tr>
                        <td><strong><?php _e('POS Operators', 'deshi-kitchen-admin'); ?></strong></td>
    ...
    private static function render_placeholder($title, $filename) {
        ...
        <div class="wrap">
            ...
            <div class="notice notice-warning">
                <p><strong><?php _e('View file not found!', 'deshi-kitchen-admin'); ?></strong></p>
                <p><?php printf(__('Please create the view file: %s', 'deshi-kitchen-admin'), '<code>' . $filename . '</code>'); ?></p>
                <p><?php printf(__('Location: %s', 'deshi-kitchen-admin'), '<code>' . DKM_ADMIN_VIEWS_DIR . '</code>'); ?></p>
            </div>
            
            <div style="background: #fff; border: 1px solid #ddd; padding: 20px; margin-top: 20px;">
                <h2><?php _e('Page Under Development', 'deshi-kitchen-admin'); ?></h2>
                <p><?php _e('This page is under development. The view file will be created soon.', 'deshi-kitchen-admin'); ?></p>
            </div>
        </div>
        <?php
    }
